...
### Added
- **One-command remote installation** via curl/wget without cloning repository
- Support for installing from specific version tags or branches
...
[1.0.1]: https://github.com/yourusername/uvm/releases/tag/v1.0.1
